      ...
      <div className={styles.container}>
        <div className={styles.heroBar}>
          ...
          <p className={styles.mainSubtitle}>
            GamerChallenges — Règles et fonctionnement de la plateforme
          </p>
        </div>
        ...
        <div className={styles.content}>
          <section className={styles.section}>
            ...
            <p>
              ...
              définissent les règles d&apos;utilisation de la plateforme{" "}
              <strong className={styles.highlight}>GamerChallenges</strong>.
            </p>
            <p>
              Toute utilisation du site implique l&apos;acceptation des
          ...
          <section className={styles.section}>
            ...
            <p>
              ...
              identifiants et de toutes les activités réalisées avec son compte.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p>
              Les contenus publiés (challenges, scores, vidéos, commentaires)
          ...
          <section className={styles.section}>
            ...
            <p>
              Les classements sont calculés automatiquement à partir des
          ...
          <section className={styles.section}>
            ...
            <p>
              La plateforme est fournie &quot;en l&apos;état&quot;. L&apos;éditeur
          ...
          <section className={styles.section}>
            ...
            <p>
              Le site et l&apos;ensemble de ses contenus (texte, images, logos,
              code) sont protégés par le droit de la propriété intellectuelle.
            </p>
            <p>
          ...
          <section className={styles.section}>
            ...
            <p>
              La plateforme peut intégrer des services externes (ex : YouTube).
              L&apos;utilisateur accepte les conditions et politiques de ces services.
            </p>
          </section>
