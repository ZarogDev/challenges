      ...
      <div className={styles.pageWrapper}>
        <div className={styles.container}>
          ...
          <div className={styles.heroBar}>
            ...
            <p className={styles.mainSubtitle}>GamerChallenges — Protection de vos données personnelles</p>
          </div>
          ...
          <div className={styles.content}>
            ...
            <section className={styles.section}>
              ...
              <p>
                La présente politique de confidentialité a pour objectif d'informer les utilisateurs de la plateforme <strong className={styles.highlight}>GamerChallenges</strong> sur la manière dont leurs données personnelles sont collectées, utilisées et protégées.
              </p>
              <p>
                L'éditeur s'engage à respecter la réglementation en vigueur, notamment le Règlement Général sur la Protection des Données (RGPD).
              </p>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p>Les données personnelles <strong className={styles.highlight}>ne sont pas vendues</strong>.</p>
            ...
            <section className={styles.section}>
              ...
              <p>L'utilisateur accepte que ces données soient visibles par les autres utilisateurs.</p>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p>Le site utilise des cookies pour assurer le bon fonctionnement de la session utilisateur, améliorer l'expérience et analyser l'utilisation du site.</p>
            ...
            <section className={styles.section}>
              ...
              <p>La plateforme est accessible à partir de <strong className={styles.highlight}>13 ans</strong>.</p>
              <p>Les mineurs doivent utiliser le service sous la responsabilité de leurs représentants légaux.</p>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p>La présente politique de confidentialité peut être modifiée à tout moment.</p>
            </section>
